...
function App() {
  ...
  return (
    <div
      className={
        dark
          ? "flex flex-col justify-center text-white bg-gray-950 items-center min-h-screen space-y-2 font-mono"
          : "flex flex-col justify-center bg-stone-300 items-center min-h-screen space-y-2 font-mono"
      }
    >
