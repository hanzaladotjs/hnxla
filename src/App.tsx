...
function App() {
  ...
  return (
    <BrowserRouter>
      <div className={light ? "flex flex-col items-center  space-y-13 font-sans tiktok-sans bg-white text-black min-h-[100vh] w-screen" : "flex flex-col items-center space-y-13 font-sans tiktok-sans bg-black text-white min-h-[100vh] w-screen"}>
