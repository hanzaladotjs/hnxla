  ...
  return (
    <BrowserRouter>
      ...
      <div className={light ? "flex flex-col items-center space-y-7 font-sans tiktok-sans bg-white text-black min-h-[100vh] w-screen" : "flex flex-col items-center space-y-7 font-sans tiktok-sans bg-black text-white min-h-[100vh] w-screen"}>
        ...
        <nav className={light ? "flex mt-5 sticky  bg-white text-stone-800 md:h-14 h-14 border-4 border-stone-700  " : "flex mt-5 bg-black sticky  rounded-md text-stone-200 md:h-14 h-14 border-4 border-stone-200 "}>
          <Link to={"/"}><button className="border-r-[3px] h-full md:w-13 flex items-center relative group inline-block">
            <img className="md:h-12 md:w-13 h-12 w-13  animation hover:animate-pulse object-center" src={dazai}></img>
         ...
         <Link to={"/projects"}><button className={light ? "border-r-[3px] h-full px-4   relative group inline-block flex items-center transition duration-400 hover:bg-gray-300" : "border-r-[2px] h-full px-4 relative group inline-block  flex items-center transition duration-400 hover:bg-gray-800"}>
          ...
          <button className={light ? "border-r-[3px] h-full px-4  relative group inline-block flex items-center transition duration-400 hover:bg-gray-300" : " relative group inline-block border-r-[2px] h-full px-4  flex items-center transition duration-400 hover:bg-gray-800"}>
            {light ? <a href="https://github.com/hanzaladotjs"><svg width="24px" height="24px" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000"><path d="M16 22.0268V19.1568C16.0375 18.68 15.9731 18.2006 15.811 17.7506C15.6489 17.3006 15.3929 16.8902 15.06 16.5468C18.2 16.1968 21.5 15.0068 21.5 9.54679C21.4997 8.15062 20.9627 6.80799 20 5.79679C20.4558 4.5753 20.4236 3.22514 19.91 2.02679C19.91 2.02679 18.73 1.67679 16 3.50679C13.708 2.88561 11.292 2.88561 8.99999 3.50679C6.26999 1.67679 5.08999 2.02679 5.08999 2.02679C4.57636 3.22514 4.54413 4.5753 4.99999 5.79679C4.03011 6.81549 3.49251 8.17026 3.49999 9.57679C3.49999 14.9968 6.79998 16.1868 9.93998 16.5768C9.61098 16.9168 9.35725 17.3222 9.19529 17.7667C9.03334 18.2112 8.96679 18.6849 8.99999 19.1568V22.0268" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M9 20.0267C6 20.9999 3.5 20.0267 2 17.0267" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg> </a> :  <a href="https://github.com/hanzaladotjs"><svg width="24px" height="24px" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#ffffff"><path d="M16 22.0268V19.1568C16.0375 18.68 15.9731 18.2006 15.811 17.7506C15.6489 17.3006 15.3929 16.8902 15.06 16.5468C18.2 16.1968 21.5 15.0068 21.5 9.54679C21.4997 8.15062 20.9627 6.80799 20 5.79679C20.4558 4.5753 20.4236 3.22514 19.91 2.02679C19.91 2.02679 18.73 1.67679 16 3.50679C13.708 2.88561 11.292 2.88561 8.99999 3.50679C6.26999 1.67679 5.08999 2.02679 5.08999 2.02679C4.57636 3.22514 4.54413 4.5753 4.99999 5.79679C4.03011 6.81549 3.49251 8.17026 3.49999 9.57679C3.49999 14.9968 6.79998 16.1868 9.93998 16.5768C9.61098 16.9168 9.35725 17.3222 9.19529 17.7667C9.03334 18.2112 8.96679 18.6849 8.99999 19.1568V22.0268" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M9 20.0267C6 20.9999 3.5 20.0267 2 17.0267" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg></a>}
            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-max  text-xs rounded py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-10">
              github
            </div>
          </button>
